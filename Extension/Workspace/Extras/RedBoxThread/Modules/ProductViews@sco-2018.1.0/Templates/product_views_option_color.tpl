		...
		{{#if showLabel}}
			<div class="product-views-option-color-label-header">
				...
				{{#if showSelectedValue}}
					<span class="product-views-option-color-value-container">
			...
			{{#each values}}
				{{#if internalId}}
					<div class="product-views-option-color-picker">
						<label class="product-views-option-color-picker-label {{#if isActive}}active{{/if}}">
							<input
							...
							{{#if isColorTile}}
                            <div class="product-views-option-color-picker-box-wrapper {{#if isActive}}active{{/if}}" data-label="label-{{../cartOptionId}}" value="{{internalId}}">
