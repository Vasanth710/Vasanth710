...
<div class="subscriptions-addon-summary-container">
    ...
    <div class="subscriptions-addon-summary-total">
        <p class="subscriptions-addon-summary-grid-float">
            <span class="subscriptions-addon-summary-grid-right">{{itemPriceTotal}}</span>
            <span class="subscriptions-addon-summary-grid-right">{{translate 'Total'}}</span>
            {{#if hasFrequency}}
    ...
    {{else}}
        <div class="subscriptions-addon-summary-discount-by-usage">
