...
{{#if isSkipLogin}}
	<p class="login-register-login-description">
		{{translate 'Login below or <a class="login-register-login-register-now" href="register" data-toggle="show-in-modal" data-type="register-now">create an account</a>'}}</p>
	{{else}}
	<p class="login-register-login-description">
