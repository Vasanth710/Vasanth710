<div class="global-views-format-payment-method">
	...
	{{#if isACH}}
		<div class="global-views-format-payment-method-header">
			<p class="global-views-format-payment-method-name"> <b>{{name}}</b> </p>
		</div>
		<p class="global-views-format-payment-method-account"><b>{{translate 'Account: '}}</b> {{account}}</p>
		<p class="global-views-format-payment-method-limit"><b>{{translate 'Limit: '}}</b> {{limit}}</p>
