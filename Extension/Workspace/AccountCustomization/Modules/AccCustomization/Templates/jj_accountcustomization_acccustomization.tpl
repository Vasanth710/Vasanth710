<div class="order-history-summary-summary-col">
  <div class="order-history-summary-summary-container">
    ...
    {{#if model.taxesPerType}}{{#each model.taxesPerType}}
    <p class="order-history-summary-summary-grid-float">
      <span class="order-history-summary-summary-amount-tax">
        {{taxTotal}}
      </span>
      {{translate taxTypeName}}
    </p>
    {{/each}}{{/if}}
  ...
  <div class="order-history-summary-row-fluid">
    ...
    <!-- REORDER ALL ITEMS -->
    <a href="/reorderItems?order_id={{model.internalid}}&order_number={{model.tranid}}"
    ...
    <a data-permissions="transactions.tranRtnAuth.2" href="/returns/new/{{model.recordtype}}/{{model.internalid}}"
    ...
    {{/if}}
    {{#if showEditButton}}
    <a href="" data-action="edit" class="order-history-summary-button-download-pdf">
      {{translate 'Edit Order'}}
    </a>
    {{/if}}

    {{#if showViewInvoiceButton}}
    <a data-permissions="" href="/invoices/{{invoiceModel.internalid}}" data-id="{{invoiceModel.internalid}}"
