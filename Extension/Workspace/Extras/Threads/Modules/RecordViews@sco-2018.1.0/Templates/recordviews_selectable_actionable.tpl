<tr class="recordviews-selectable-actionable-row {{#if isChecked}}recordviews-selectable-actionable-active{{/if}} {{#unless isActive}}disabled{{/unless}}" data-action="{{actionType}}" data-id="{{id}}">
	{{#unless checkboxIsHidden}}
		<td class="recordviews-selectable-actionable-td-selectable">
			<input class="recordviews-selectable-actionable-checkbox hidden" type="checkbox" value="{{id}}" data-action="select" {{#if isChecked}}checked{{/if}} {{#unless isActive}}disabled{{/unless}}>
		</td>
	{{/unless}}
	...
	<td class="recordviews-selectable-actionable-td-action" data-view="Action.View"></td>
</tr>
